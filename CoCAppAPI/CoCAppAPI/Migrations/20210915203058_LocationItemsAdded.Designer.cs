...
namespace CoCAppAPI.Migrations
{
    ...
    [Migration("20210915203058_LocationItemsAdded")]
    partial class LocationItemsAdded
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DbLibrary.Models.Location.LocationItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("DbLibrary.Models.Location.LocationNote", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("LocationNotes");
                });

            modelBuilder.Entity("DbLibrary.Models.Note.Note", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("DbLibrary.Models.Location.LocationItem", b =>
                {
                    ...
                    b.HasOne("DbLibrary.Models.Location.Location", "Location")
                        .WithMany("LocationItems")
            ...
            modelBuilder.Entity("DbLibrary.Models.Location.LocationNote", b =>
                {
                    b.HasOne("DbLibrary.Models.Location.Location", "Location")
                        .WithMany("LocationNotes")
                        .HasForeignKey("LocationId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("DbLibrary.Models.Note.Note", "Note")
                        .WithMany("LocationNotes")
